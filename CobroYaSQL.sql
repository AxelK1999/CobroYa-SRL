...
create table Empleados(
	PK_Dni_emp NUMERIC(13,0) not null, -- DNI del empleado
	Nom_emp varchar(25) not null, -- nombre
	Ape_emp varchar(25)not null, --apellido
	primary key(PK_Dni_emp)
);
create table Localidad(
	PK_Cod_Postal NUMERIC(4,0) not null, --codigo postal
	Ciudad varchar(15), --ciudad
	primary key (PK_Cod_Postal)
);
create table Empresas(
	PK_Cuit NUMERIC(11,0) not null, --cuit empresa que contrato a cobroYA
	Nom_empresa varchar(25) not null, --nombre empresa
	Correo varchar(35)not null, --correo
	FK_dni NUMERIC(13,0) not null, --dni del empleado a cargo
	FK_CodPostE NUMERIC(4,0) not null, -- código postal del ciudad
	primary key(PK_Cuit),
...
create table DeudorEmpresa(
	PK_id serial,
	FK_Cuit NUMERIC(11,0) not null,
	FK_Dni_deu NUMERIC(13,0) not null,
	primary key(PK_id),
...
create table Deudores(
	PK_Dni_deu NUMERIC(13,0) not null, --dni
	...
	FK_CodPostD NUMERIC(4,0) not null, -- código postal de la ciudad
...
create table Email(
	...
	FK_Dni_deu NUMERIC(13,0) not null, -- dni del cliente deudor
	primary key(PK_Mail,FK_Dni_deu),
	foreign key (FK_Dni_deu) references Deudores(PK_Dni_deu)
);
create table Telefono(
	PK_Num_Tel NUMERIC(15,0) not null, --numero de teléfono (considera numeros a nivel intenacional)
	Tipo varchar(8) not null, -- tipo de telefono
	FK_Dni_deuT NUMERIC(13,0) not null, -- dni del deudor
...
create table FormaPago(
	...
	Comision Float not null, -- porcentaje o una cantidad fija de dinero que se cobra como tarifa adicional por realizar una transacción 
	Cant_Cuotas int not null,-- cantidad de cuotas
	Intereses Float not null, --intereses
...
create table Convenio(
	...
	FK_Dni_deuC NUMERIC(13,0) not null,-- deni del cliente deudor
